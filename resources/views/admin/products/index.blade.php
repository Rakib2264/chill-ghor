...
@section('content')
    <div class="rounded-2xl border border-charcoal/10 bg-white shadow-soft overflow-hidden">
        ...
        <div class="flex flex-wrap items-center gap-3 border-b border-charcoal/8 p-4">
            ...
            <a href="{{ route('admin.products.trash') }}" class="rounded-full bg-cream px-4 py-2 text-sm font-bold">
                    ...
                    @forelse($products as $p)
                        <tr class="border-t border-charcoal/5 hover:bg-cream/40 transition-colors">
                            ...
                            <td class="py-3 px-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-charcoal/45 truncate max-w-[180px]">{{ $p->description }}
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                @elseif($p->stock === 0)
                                    <span
                                        class="rounded-full bg-red-100 px-2.5 py-1 text-xs font-black text-red-700">শেষ</span>
                                @elseif($p->stock <= 5)
                                    <span
                                        class="rounded-full bg-orange-100 px-2.5 py-1 text-xs font-black text-orange-700">⚡
                                        {{ $p->stock }}টি</span>
                                @else
                            ...
                            {{-- ✅ Views --}}
                            <td class="px-4 py-3 text-center">
                                <span class="text-xs text-charcoal/50"><i class="fas fa-eye"></i>
                                    {{ $p->views_label }}</span>
                            </td>
