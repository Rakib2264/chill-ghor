    ...
    <div class="flex min-h-screen items-center justify-center px-4">
        <div class="w-full max-w-md">
            ...
            <div class="rounded-3xl border border-charcoal/10 bg-white p-8 shadow-warm">
                ...
                <p class="mt-1 text-sm text-charcoal/60">লগইন করে বিশেষ অফার পান</p>
                ...
                <form action="{{ route('login') }}" method="POST" class="mt-6 space-y-4">
                    ...
                    <button
                        class="w-full rounded-full bg-gradient-warm py-3 text-sm font-bold text-white shadow-warm transition hover:scale-[1.02]">লগইন
                        করুন →</button>
                </form>
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('home') }}" class="text-xs font-bold text-charcoal/60 hover:text-primary">← মূল সাইটে
                    ফিরে যান</a>
            </div>
        </div>
    </div>
