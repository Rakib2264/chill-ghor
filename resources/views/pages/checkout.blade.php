...
@section('content')
    <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8" x-data="checkoutSpa({
                ...
                <dl class="space-y-2 text-sm">
                    ...
                    @if (!empty($discount) && $discount > 0)
                        <div class="flex justify-between text-green-600">
                            ...
                            <dd class="font-bold">−৳{{ number_format($discount) }}</dd>
                        </div>
                    @endif
            ...
            <div class="rounded-2xl border border-charcoal/10 bg-white p-6 shadow-soft">
                        ...
                        <template x-for="addr in addresses" :key="addr.id">
                            <label class="flex cursor-pointer items-start gap-3 rounded-xl border-2 p-3 transition"
                                ...
                                <div class="flex-1 text-sm">
                                    ...
                                    <div class="text-xs text-charcoal/70" x-text="addr.recipient_name + ' · ' + addr.phone">
                                    </div>
                ...
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <label class="block">
                        ...
                        <input type="email" x-model="form.email" required placeholder="example@gmail.com"
                            class="mt-1 w-full rounded-xl border border-charcoal/15 bg-cream px-4 py-3 text-sm focus:border-primary focus:outline-none">
                    </label>
                    <label class="block">
                    ...
                    <label class="block">
                        ...
                        <input type="text" x-model="form.area" placeholder="যেমন: ধানমন্ডি ৩২"
                            class="mt-1 w-full rounded-xl border border-charcoal/15 bg-cream px-4 py-3 text-sm focus:border-primary focus:outline-none">
                    </label>
                    <label class="block sm:col-span-2">
