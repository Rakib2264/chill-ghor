...
@section('content')
    <div class="min-h-screen" style="background:#f8f4f0;">
        ...
        {{-- ── BREADCRUMB ── --}}
        <div class="mx-auto max-w-6xl px-4 pt-2 sm:px-6 lg:px-8">
        ...
        {{-- ── MAIN GRID ── --}}
        <div class="mx-auto max-w-6xl px-4 py-2 sm:px-6 lg:py-8 lg:px-8">
           ...
           ════════════════════════════ --}}
                <div class="relative">
                    ...
                    @if ($product->reviews_count > 0)
                        ...
                        <div
                            class="mt-2 flex items-center justify-between rounded-2xl bg-white px-5 py-3 shadow-sm border border-charcoal/6">
