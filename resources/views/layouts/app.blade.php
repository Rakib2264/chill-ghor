...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 16px 30px -12px rgba(192, 57, 43, .45);
        ...
        .lift:hover {
            ...
            box-shadow: 0 22px 40px -22px rgba(28, 15, 9, 0.25);
        }
        ...
        .chip {
            ...
            background: #fff;
            border: 1px solid rgba(42, 29, 24, .10);
            font-weight: 700;
            font-size: .75rem;
        ...
        .chip-active {
            ...
            box-shadow: 0 8px 18px -8px rgba(192, 57, 43, .5);
        }
    </style>

    @stack('head')
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-ZPYVTYKSB6"></script>
    <script>
